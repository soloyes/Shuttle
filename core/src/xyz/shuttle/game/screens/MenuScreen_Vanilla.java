 ...
 */
public class MenuScreen_Vanilla implements Screen {
    ...
    public MenuScreen_Vanilla(SpriteBatch batch) {
        this.batch = batch;
    }
...
//        music.play();
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font96.draw(batch, "LibGDX Core", 0, 600 + 20.0f * (float) Math.sin(time), 1280, 1, false);
        batch.end();
        stage.draw();
    }
